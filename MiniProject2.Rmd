...
```{r}
Big_N_cnt2 <- adsl_eff %>% group_by(TRT01AN, TRT01A, AGEGR1N, AGEGR1) %>%
  count(name = "N")

small_n_cnt2 <- adsl_eff %>% group_by(TRT01AN, TRT01A, AGEGR1N, AGEGR1, SEX) %>%
  count(name = "n")
