...
#error in deriving perc caused by summarise(name = "n") line in deriving the small_n_cnt dataset
```
...
```{r, eval=FALSE}
#to fix: change summarise(name = "n") to count(name="n") or summarise(n=n())
